...
class AdminReact
{
    ...
    public static function layout(string $pageTitle, string $activeKey): array
    {
        $items = [
            ...
            'logs' => ['label' => 'Bitacora', 'href' => route('dashboard.logs'), 'icon' => 'ri-history-line', 'page' => 'adminLogs'],
            'backups' => ['label' => 'Respaldos', 'href' => route('dashboard.backups'), 'icon' => 'ri-shield-keyhole-line', 'page' => 'adminBackups'],
