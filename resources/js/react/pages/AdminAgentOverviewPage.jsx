    ...
    const configFactory = () => ({
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: 'rgba(11, 79, 193, 0.82)',
                    ...
                    <div className="fit-agent-chart-stack">
                        <div className="fit-transfer-panel">
                            ...
                            <LazyChart
                                configFactory={() => ({
                                    type: 'bar',
                                    data: { labels: selectedDetail.weekly?.labels || [], datasets: [{ data: selectedDetail.weekly?.data || [], backgroundColor: 'rgba(11, 79, 193, 0.82)', borderRadius: 10, borderSkipped: false }] },
