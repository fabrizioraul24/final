...
export default function DualBarChartCard({ data: dashboardData }) {
  ...
  const data = roleLabels.length
    ...
    : [
        { day: 'Dom', coral: 40, peach: 65 },
        { day: 'Lun', coral: 70, peach: 45 },
        { day: 'Mar', coral: 35, peach: 80 },
        { day: 'Mie', coral: 25, peach: 50 },
        { day: 'Jue', coral: 90, peach: 60 },
        { day: 'Vie', coral: 55, peach: 75 },
        { day: 'Sab', coral: 80, peach: 90 },
      ];
      ...
      <div className="h-36 w-full">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 5, right: 5, left: -25, bottom: 0 }} barGap={3}>
            ...
            <YAxis hide />
            <Tooltip />
            <Bar dataKey="coral" fill="#f25a59" radius={[4, 4, 0, 0]} />
            <Bar dataKey="peach" fill="#7ea6ff" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
