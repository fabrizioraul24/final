...
export default function Sidebar() {
  ...
  const navButtons = [
    { href: '/dashboard/admin', label: 'Dashboard Consola', icon: LayoutGrid, desc: 'Panel Principal' },
    ...
    { href: '/dashboard/logs', label: 'Logs', icon: History, desc: 'Bitacora del sistema' },
    { href: '/dashboard/backups', label: 'Backups', icon: Boxes, desc: 'Respaldo de datos' },
