        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 font-medium">
              Añade un nuevo perfil para actualizar métricas en vivo en el Dashboard 1 y Dashboard 2.
            </p>
          </div>
        </div>
        ...
        <div className={`lg:col-span-8 p-8 rounded-3xl border transition-all ${
          ...
          {registeredSuccess && (
            <div className="mb-6 p-4 rounded-2xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-400 text-xs font-bold flex items-center gap-3 animate-in fade-in">
              ...
              <span>¡Usuario creado exitosamente! Métricas de los Dashboards actualizadas.</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Trainer">Entrenador (Coach Elite)</option>
              ...
              <div>
                ...
                >
                  ...
                  <option value="Monthly Pass">Pase Mensual ($29/mes)</option>
            ...
            <div className="pt-4 flex items-center justify-end">
              ...
              >
                ...
                <span>Registrar Usuario y Actualizar Dashboards</span>
              </button>
            </div>
          </form>
        </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className={`p-6 rounded-3xl border ${
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Cada usuario agregado incrementará automáticamente el total de suscriptores diarios (+1) y sumará al cálculo estimado de ingresos de ambos Dashboards.
            </p>
          </div>
        </div>
      </div>
