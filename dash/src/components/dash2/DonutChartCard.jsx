...
export default function DonutChartCard() {
  ...
  const data = [
    { name: 'Ipsum (70%)', value: 70, color: '#f97316' },
    { name: 'Lorem (30%)', value: 30, color: '#6366f1' },
  ];
  ...
  return (
    <div className={`p-6 rounded-3xl border transition-all duration-300 flex flex-col justify-between ${
      ...
      <div className="flex items-center justify-between mb-2">
        <h3 className="text-sm font-bold tracking-tight">Consectetuer</h3>
      ...
      <div className="relative h-36 w-full flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
          ...
          <span className="text-[9px] text-slate-400 font-semibold">Lorem</span>
